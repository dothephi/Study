...
********************************************************************************/
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'PE_DBI202_FALL2022')
BEGIN
	ALTER DATABASE [PE_DBI202_FALL2022] SET OFFLINE WITH ROLLBACK IMMEDIATE;
	ALTER DATABASE [PE_DBI202_FALL2022] SET ONLINE;
	DROP DATABASE [PE_DBI202_FALL2022];
END

GO

CREATE DATABASE [PE_DBI202_FALL2022]
GO

USE [PE_DBI202_FALL2022]
GO
